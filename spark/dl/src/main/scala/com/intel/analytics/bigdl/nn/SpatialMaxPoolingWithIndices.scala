 ...
 * 
 * Unlike SpatialMaxPooling, WithIndices also outputs the indices of the maxima 
 * values, for use in an unpooling layer.
 *
...
class SpatialMaxPoolingWithIndices[T: ClassTag](
   ...
   * @return this
   */
  def ceil(): SpatialMaxPoolingWithIndices[T] = {
    ceilMode = true
    this
  }
   ...
   * @return this
   */
  def floor(): SpatialMaxPoolingWithIndices[T] = {
    ceilMode = false
    this
  }
...
object SpatialMaxPoolingWithIndices extends ModuleSerializable {
  def apply[@specialized(Float, Double) T: ClassTag](
      ...
      (implicit ev: TensorNumeric[T]): SpatialMaxPoolingWithIndices[T] = {
    new SpatialMaxPoolingWithIndices[T](kW, kH, dW, dH, padW, padH, format)
  }
